...
Using **XGBoost** models optimized via **GridSearchCV** and balanced via **SMOTE**, the system achieved high-accuracy predictive thresholds:
...
* **Optimization & Visualization:** GridSearchCV, Streamlit Cloud
